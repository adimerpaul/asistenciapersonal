                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        >
                            <li class="nav-item">
                                <a class="nav-link" :href="href" @click="navigate" :class="[isActive && 'active', isExactActive && '']">
                                    <i class="fa fa-user-astronaut"></i> Personal de trabajo
                        ...
                        >
                            <li class="nav-item">
                                <a class="nav-link" :href="href" @click="navigate" :class="[isActive && 'active', isExactActive && '']">
                                    <i class="fa fa-print"></i> Imprimir Lista de asistencia
                                </a>
                            </li>
                        </router-link>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"><i class="fa fa-credit-card"></i> {{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
